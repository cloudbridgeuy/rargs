...
usage() {
  ...
  printf "\n\033[4m%s\033[0m\n" "Usage:"
  printf "  basic -M|--options-with-multiple-and-required <OPTIONS-WITH-MULTIPLE-AND-REQUIRED> -z|--options-with-required <OPTIONS-WITH-REQUIRED> [OPTIONS] [COMMAND] [COMMAND_OPTIONS]\n"
  printf "  basic -h|--help\n"
